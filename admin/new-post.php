                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="white-box">
                            ...
                            <p class="text-muted m-b-30 font-13"> A blog post contains the title , Description and image that needs to.</p>
                            <div id="exampleValidator" class="wizard">
                                <ul class="wizard-steps" role="tablist">
                                    <li class="active" role="tab">
                                        <h4><span><i class="ti-user"></i></span>Title</h4> </li>
                                    <li role="tab">
                                        <h4><span><i class="ti-marker-alt"></i></span>description</h4> </li>
                                    <li role="tab">
                                        <h4><span><i class="ti-book"></i></span>Image</h4> </li>
                                </ul>
                                    ...
                                    <div class="wizard-content">
                                        <div class="wizard-pane active" role="tabpanel">
                                            <div class="form-group">
                                                ...
                                                <div class="col-xs-5">
                                                    <input type="text" class="form-control" name="author" value="admin"/> </div>
                                            </div>
                                        </div>
                                        <div class="wizard-pane" role="tabpanel">
                                            <div class="form-group">
                                                ...
                                                <div class="col-xs-5">
                                                    <<textarea class="form-control" name="title" required > </textarea> </div>
                                            </div>
                                        </div>
                                        <div class="wizard-pane" role="tabpanel">
                                            <div class="form-group">
                                                ...
                                                <div class="col-xs-5">
                                                    <input type="file" class = "form-control btn btn-outline "  />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
