                ...
                <div class="row bg-title">
                    ...
                    <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
                        <ol class="breadcrumb">
                            ...
                            <li class="active"> <a href="new-user.php"
                                    class="btn btn-success btn-rounded btn-outline hidden-xs hidden-sm waves-effect waves-light">Create
                                    New Admin</a></li>
                        </ol>
                    </div>
                    <!-- /.col-lg-12 -->
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12">
                        <div class="white-box">
                            ...
                            <h3 class="box-title m-b-0">Company Administrators ( <x style="color: orange;">
